RSpec.describe Item do
  ...
  describe 'validations' do
    describe 'valid context' do
      ...
      item = Item.create(title: 't-shirt', description: 'you can wear it if you want', price: 10.00, img: './default-photo.png')
    ...
    describe 'invalid context' do
      it 'should be invalid if missing a unique title' do
        item = Item.create(description: 'what item?', price: 0.00, img: './default-photo.png')
      ...
      it 'should be invalid if missing description' do
        item = Item.create(title: 'empty box', price: 1.00, img: './default-photo.png')
      ...
      it 'should be invalid if missing image' do
        item = Item.create(title: 'Really cool item', description: 'if only you could see it', price: 9.00)
